<!-- Page content -->
                    <div id="page-content">
                            ...
                            <div class="header-section">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                        <h1>Welcome <strong><?php  if(isset($_SESSION['UserData']['name']) && !empty($_SESSION['UserData']['name'])) { echo ucfirst($_SESSION['UserData']['name']); }  else {  echo "Admin"; }?></strong><br><small>You Look Awesome!</small></h1>
                                    </div>
                                    <!-- END Main Title -->

                                    <!-- Top Stats -->
                                    <div class="col-md-8 col-lg-6 hide">
						...
						<div class="col-sm-6 col-lg-3">
                                <!-- Widget -->
                                <a href="<?php echo $this->html->url('/admin/dashboard/manage_users/', true);?>" class="widget widget-hover-effect1">
                                    <div class="widget-simple">
                                        <div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
                                            <i class=" gi gi-user"></i>
                                        </div>
                                        <h3 class="widget-content text-right animation-pullDown">
                                            <?php  echo $data['usersCount'];?> <strong>Users</strong><br>
                                            <small>Manage</small>
                                        </h3>
                                    </div>
                                </a>
						...
						<div class="col-sm-6 col-lg-3">
                                <!-- Widget -->
                                <a href="<?php echo $this->html->url('/admin/dashboard/manage_races/', true);?>" class="widget widget-hover-effect1">
                                    <div class="widget-simple">
                                        <div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
							...
							<div class="col-sm-6 col-lg-3">
                                <!-- Widget -->
                                <a href="<?php echo $this->html->url('/admin/dashboard/manage_body_types/', true);?>" class="widget widget-hover-effect1">
                                    <div class="widget-simple">
                                        <div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
                                            <i class="fa fa-calendar-o"></i>
                                        </div>
                                        <h3 class="widget-content text-right animation-pullDown">
                                            <strong>Body Types</strong><br>
                                            <small>Manage</small>
                                        </h3>
                                    </div>
                                </a>
							...
							<div class="col-sm-6 col-lg-3">
                                <!-- Widget -->
                                <a href="<?php echo $this->html->url('/admin/dashboard/manage_contact_data/', true);?>" class="widget widget-hover-effect1">
                                    <div class="widget-simple">
                                        <div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
                                            <i class="gi gi-envelope"></i>
                                        </div>
                                        <h3 class="widget-content text-right animation-pullDown">
                                            <strong>Contact Queries</strong><br>
                                            <small>Manage</small>
                                        </h3>
                                    </div>
                                </a>
							...
							<div class="col-sm-6 col-lg-3">
                                <!-- Widget -->
                                <a href="<?php echo $this->html->url('/admin/dashboard/manage_pages/', true);?>" class="widget widget-hover-effect1">
                                    <div class="widget-simple">
                                        <div class="widget-icon pull-left themed-background-autumn animation-fadeIn">
