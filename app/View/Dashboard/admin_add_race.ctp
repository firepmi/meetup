                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Add Race</h2>
                                    </div>
                                    <!-- END Horizontal Form Title -->

                                    <!-- Horizontal Form Content -->
                                    
									<?php  echo $this->Form->create('Race', array('type' => 'post', 'id'=>'form-login','class'=>'form-horizontal form-bordered','url' => array('controller' => 'Dashboard', 'action' => 'add_race'))); ?>
									
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-hf-email">Race Name</label>
                                            <div class="col-md-9">
                                                <input type="text" id="example-hf-email" name="race_name" class="form-control" placeholder="Enter Race Name">
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="radio" name="race_status" checked value='1'> Enabled&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="race_status" value='0'> Disabled
                                            </div>
                                        </div>
